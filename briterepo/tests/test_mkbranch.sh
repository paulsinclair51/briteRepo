...
mv "$WORK/briterepo/bin/helpers/history_log.sh" \
  "$WORK/briterepo/bin/helpers/history_log.sh.bak"
...
mv "$WORK/briterepo/bin/helpers/history_log.sh.bak" \
  "$WORK/briterepo/bin/helpers/history_log.sh"

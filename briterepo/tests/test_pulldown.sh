...
PULLDOWN_WORKFLOW_SRC="$REPO_ROOT/briterepo/bin/helpers/pulldown_workflow.sh"
...
cp "$PULLDOWN_WORKFLOW_SRC" "$WORK/briterepo/bin/helpers/pulldown_workflow.sh"
...
set -euo pipefail
source ./briterepo/bin/helpers/pulldown_workflow.sh
bt_pulldown_init
PUSHUP_SYNC=true
ORIGINAL_ARGS=()
bt_pulldown_run

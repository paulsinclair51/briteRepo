...
PUSH_COMMAND_SRC="$REPO_ROOT/briterepo/bin/helpers/push_command.sh"
...
REPORT_SYNC_HELPER_SRC="$REPO_ROOT/briterepo/bin/helpers/report_sync.sh"
PUSH_WORKFLOW_HELPER_SRC="$REPO_ROOT/briterepo/bin/helpers/push_workflow.sh"
CKROLE_HELPER_SRC="$REPO_ROOT/briterepo/bin/helpers/ckrole.sh"
...
cp "$PUSH_COMMAND_SRC" "$WORK/briterepo/bin/helpers/push_command.sh"
...
cp "$REPORT_SYNC_HELPER_SRC" "$WORK/briterepo/bin/helpers/report_sync.sh"
cp "$PUSH_WORKFLOW_HELPER_SRC" "$WORK/briterepo/bin/helpers/push_workflow.sh"
cp "$CKROLE_HELPER_SRC" "$WORK/briterepo/bin/helpers/ckrole.sh"
chmod +x "$WORK/briterepo/bin/push" "$WORK/briterepo/bin/helpers/ckrole.sh"
...
mkdir -p "$PUSHUP_WORK/briterepo/bin" "$PUSHUP_WORK/briterepo/bin/helpers" \
  "$PUSHUP_WORK/config" "$PUSHUP_WORK/reports" "$PUSHUP_BIN"
cp "$PUSH_SRC" "$PUSHUP_WORK/briterepo/bin/push"
cp "$PUSH_COMMAND_SRC" "$PUSHUP_WORK/briterepo/bin/helpers/push_command.sh"
cp "$COMMON_HELPER_SRC" "$PUSHUP_WORK/briterepo/bin/helpers/common.sh"
cp "$GIT_HELPER_SRC" "$PUSHUP_WORK/briterepo/bin/helpers/git_helpers.sh"
cp "$GITHUB_HELPER_SRC" "$PUSHUP_WORK/briterepo/bin/helpers/github_helpers.sh"
cp "$HISTORY_HELPER_SRC" "$PUSHUP_WORK/briterepo/bin/helpers/history_log.sh"
cp "$REPORT_HELPER_SRC" "$PUSHUP_WORK/briterepo/bin/helpers/report_helpers.sh"
cp "$REPORT_SYNC_HELPER_SRC" "$PUSHUP_WORK/briterepo/bin/helpers/report_sync.sh"
cp "$PUSH_WORKFLOW_HELPER_SRC" "$PUSHUP_WORK/briterepo/bin/helpers/push_workflow.sh"
...
(
  ...
  source briterepo/bin/helpers/history_log.sh
...
set -euo pipefail
source ./briterepo/bin/helpers/push_command.sh
bt_push_init

...
current_branch="$(source "$SCRIPT_DIR/../bin/helpers/common.sh"; \
  bt_get_current_branch_or_empty)"
parent_branch="$(source "$SCRIPT_DIR/../bin/helpers/common.sh"; \
...
snapshot_branch="$(source "$SCRIPT_DIR/../bin/helpers/common.sh"; \
  bt_get_current_branch_or_empty)"

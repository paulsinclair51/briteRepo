...
VALIDATION_HELPER_SRC="$REPO_ROOT/briterepo/bin/helpers/validation_helpers.sh"
COMMON_UTILS_HELPER_SRC="$REPO_ROOT/briterepo/bin/helpers/common_utils.sh"
...
cp "$VALIDATION_HELPER_SRC" "$WORK/briterepo/bin/helpers/validation_helpers.sh"
cp "$COMMON_UTILS_HELPER_SRC" "$WORK/briterepo/bin/helpers/common_utils.sh"
